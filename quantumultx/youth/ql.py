...
#gitEE Token令牌
ACCESS_TOKE = '4812bd82fc4e0f00762094438c45292c'
#gitEE owner
OWNER = 'ainsof'
#gitEE repo
REPO = 'jdck'
...
QL_Login_name = 'admin'
#青龙登录密码
QL_Login_password = 'adminadmin'

# 127.0.0.1有的环境出现无法访问，最好还是改成本地ip
URL_QL = 'http://ainsof.top:5700'
...
URL_QL_Login = URL_QL+'/open/auth/token?client_id=GP8-6EOSVg4H&client_secret=UW3TTt1XFWO6-5EVo7-8Ham0'
#查询环境变量接口
